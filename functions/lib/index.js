...
exports.triageSupportTicket = exports.onTicketCreated = exports.consumeCountryChangeTicket = exports.onBreedStandardWrite = exports.adminRejectTraitPromotion = exports.adminApproveTraitPromotion = exports.onObservationCreated = exports.adminOverrideSubscription = exports.adminUpdateUserRole = exports.onUserCreated = exports.onIncubationDeleted = exports.onIncubationCreated = exports.onSubscriptionUpdated = exports.provisionAdminClaims = exports.onFinancialEntryWrite = exports.deleteAccount = exports.lemonSqueezyWebhook = exports.paddleWebhook = exports.stripeWebhook = exports.handlePlayStoreNotification = exports.verifyPlaySubscription = void 0;
...
var billing_play_1 = require("./billing_play");
Object.defineProperty(exports, "verifyPlaySubscription", { enumerable: true, get: function () { return billing_play_1.verifyPlaySubscription; } });
var play_rtdn_1 = require("./play_rtdn");
Object.defineProperty(exports, "handlePlayStoreNotification", { enumerable: true, get: function () { return play_rtdn_1.handlePlayStoreNotification; } });
var webhooks_1 = require("./webhooks");
Object.defineProperty(exports, "stripeWebhook", { enumerable: true, get: function () { return webhooks_1.stripeWebhook; } });
Object.defineProperty(exports, "paddleWebhook", { enumerable: true, get: function () { return webhooks_1.paddleWebhook; } });
Object.defineProperty(exports, "lemonSqueezyWebhook", { enumerable: true, get: function () { return webhooks_1.lemonSqueezyWebhook; } });
// 2. Account Management
var account_management_1 = require("./account_management");
Object.defineProperty(exports, "deleteAccount", { enumerable: true, get: function () { return account_management_1.deleteAccount; } });
// 3. Financials
var financial_aggregator_1 = require("./financial_aggregator");
Object.defineProperty(exports, "onFinancialEntryWrite", { enumerable: true, get: function () { return financial_aggregator_1.onFinancialEntryWrite; } });
var admin_provisioning_1 = require("./admin_provisioning");
Object.defineProperty(exports, "provisionAdminClaims", { enumerable: true, get: function () { return admin_provisioning_1.provisionAdminClaims; } });
// =================================================================================
 ...
 */
exports.onSubscriptionUpdated = functions.firestore.document("userPurchases/{uid}").onWrite(async (change, context) => {
 ...
 */
exports.onIncubationCreated = functions.firestore
    .document('incubations/{incubationId}')
    .onCreate(async (snapshot, context) => {
    const data = snapshot.data();
    const ownerId = data === null || data === void 0 ? void 0 : data.ownerId;
    if (!ownerId) {
 ...
 */
exports.onIncubationDeleted = functions.firestore
    .document('incubations/{incubationId}')
...
exports.adminUpdateUserRole = functions.https.onCall(async (data, context) => {
    ...
    if (!context.auth || !context.auth.token.isAdmin) {
        throw new functions.https.HttpsError("permission-denied", "Only global admins can modify user roles.");
    }
 ...
 */
exports.adminOverrideSubscription = functions.https.onCall(async (data, context) => {
    // 1. Verify Caller Authorisation
    if (!context.auth || !context.auth.token.isAdmin) {
 ...
 */
exports.onObservationCreated = functions.firestore
    ...
    if (evidenceCount >= PROMOTION_THRESHOLD) {
        ...
        if (!requestDoc.exists || ((_a = requestDoc.data()) === null || _a === void 0 ? void 0 : _a.status) !== "approved") {
            await requestRef.set({
                traitId,
                breedId,
                evidenceCount,
                confidenceScore: Math.min(evidenceCount / 50, 1.0),
                status: "pending",
                lastUpdatedAt: admin.firestore.FieldValue.serverTimestamp(),
                createdAt: requestDoc.exists ? (_b = requestDoc.data()) === null || _b === void 0 ? void 0 : _b.createdAt : admin.firestore.FieldValue.serverTimestamp()
            }, { merge: true });
        }
    }
});
exports.adminApproveTraitPromotion = functions.https.onCall(async (data, context) => {
    if (!context.auth || !context.auth.token.isAdmin) {
    ...
    await firestore.runTransaction(async (transaction) => {
        ...
        const existingFixedTraits = ((_b = (_a = breedDoc.data()) === null || _a === void 0 ? void 0 : _a.geneticProfile) === null || _b === void 0 ? void 0 : _b.fixedTraits) || [];
...
exports.adminRejectTraitPromotion = functions.https.onCall(async (data, context) => {
    if (!context.auth || !context.auth.token.isAdmin) {
        throw new functions.https.HttpsError("permission-denied", "Admin only.");
    }
 ...
 */
exports.onBreedStandardWrite = functions.firestore
    ...
    const hasFixedTraits = (((_a = data.geneticProfile) === null || _a === void 0 ? void 0 : _a.fixedTraits) || []).length > 0;
    const hasInferredTraits = (((_b = data.geneticProfile) === null || _b === void 0 ? void 0 : _b.inferredTraits) || []).length > 0;
    if (!hasFixedTraits && !hasInferredTraits) {
        ...
        if (comb === "pea")
            inferred.push("P_gene");
        else if (comb === "rose")
            inferred.push("R_gene");
        else if (comb === "walnut")
            inferred.push("P_gene", "R_gene");
        // 2. Feather Type
        const feather = (data.featherType || "").toLowerCase();
        if (feather === "frizzle")
            inferred.push("F_gene");
        else if (feather === "silkied")
            inferred.push("h_gene");
        // 3. Skin Color
        if ((data.skinColor || "").toLowerCase() === "black")
            inferred.push("Fm_gene");
        // 4. Egg Color
        const egg = (data.eggColor || "").toLowerCase();
        if (egg.includes("blue") || egg.includes("green"))
            inferred.push("O_gene");
 ...
 */
exports.consumeCountryChangeTicket = functions.https.onCall(async (data, context) => {
    // 1. AUTHENTICATION
    if (!context.auth) {
    ...
    try {
        await firestore.runTransaction(async (transaction) => {
            ...
            if (!ticketData)
                throw new functions.https.HttpsError("not-found", "Ticket data missing.");
            // Verify Ownership
            ...
            if ((changeRequest === null || changeRequest === void 0 ? void 0 : changeRequest.type) !== "COUNTRY_CHANGE") {
            ...
            transaction.update(userRef, {
                ...
                currencyCode: newCurrency || determineDefaultCurrency(newCountry),
...
exports.onTicketCreated = functions.firestore
    ...
    const subject = `[HatchTracker Support] New Ticket - ${((_a = ticket.category) === null || _a === void 0 ? void 0 : _a.moduleName) || "General"}`;
    const bodyContent = `
            <strong>Ticket ID:</strong> ${ticketId}<br/>
            <strong>User:</strong> ${ticket.userEmail} (${ticket.userId})<br/>
            <strong>Category:</strong> ${(_b = ticket.category) === null || _b === void 0 ? void 0 : _b.moduleName} > ${(_c = ticket.category) === null || _c === void 0 ? void 0 : _c.featureName}<br/>
            <strong>Priority:</strong> ${ticket.priority || "MEDIUM"}<br/>
            <hr/>
            <h3>Description:</h3>
            <p style="white-space: pre-wrap;">${ticket.description}</p>
            <hr/>
            <strong>Device:</strong> ${((_d = ticket.deviceInfo) === null || _d === void 0 ? void 0 : _d.model) || "Unknown"} (Android ${((_e = ticket.deviceInfo) === null || _e === void 0 ? void 0 : _e.os_version) || "?"})<br/>
            <strong>App Version:</strong> ${ticket.appVersion || "?"}
        `;
    try {
        await (0, email_utils_1.triggerTransactionalEmail)(ticket.userId, // Associate audit log with the user who created it
        supportEmail, // Send TO the admin
        "admin_ticket_alert", subject, (0, email_utils_1.generateEmailHtml)("New Support Request", bodyContent), { ticketId: ticketId });
    }
    catch (error) {
 ...
 */
exports.triageSupportTicket = functions.firestore
    .document("tickets/{ticketId}")
    .onCreate(async (snapshot, context) => {
    const ticket = snapshot.data();
    const ticketId = context.params.ticketId;
    ...
    if (ticket.hatchyTriage)
        return;
    try {
        // Lazy load to avoid circular dep issues in some envs
        const { triageTicket } = await Promise.resolve().then(() => require("./triage_utils"));
        console.log(`Hatchy is analyzing ticket ${ticketId}...`);
        const result = await triageTicket(ticket.description, ticket.category || {});
        // Write back to Firestore
        await snapshot.ref.set({
            hatchyTriage: Object.assign(Object.assign({}, result), { processedAt: admin.firestore.FieldValue.serverTimestamp(), modelUsed: "hatchy-heuristic-v1" })
        }, { merge: true });
