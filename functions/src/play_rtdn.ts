...
import { verifySubscriptionInternal } from "./billing_play";
 ...
 */
export const handlePlayStoreNotification = functions.https.onRequest(async (req, res) => {
    try {
        let messageData: any;
        ...
        if (subscriptionNotification) {
            ...
            await verifySubscriptionInternal(uid, purchaseToken, subscriptionId, packageName);
