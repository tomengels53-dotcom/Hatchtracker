 ...
 */
export const onFinancialEntryWrite = functions.firestore
    ...
    .onWrite(async (change, context) => {
        ...
        const summaryUpdate: any = {
            ownerType,
            ownerId,
            totalCosts: totalCostsGross, // Gross is standard for "Total Cost" display
